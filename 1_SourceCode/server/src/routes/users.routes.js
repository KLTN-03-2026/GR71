...
router.get('/recommendations', authUser, asyncHandler(userController.getRecommendations));
...
router.get('/admin/dashboard', authAdmin, asyncHandler(userController.getDashboard));
