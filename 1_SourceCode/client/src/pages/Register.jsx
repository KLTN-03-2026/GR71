            ...
            <main className="flex-grow flex items-center justify-center bg-gray-100 py-12">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:flex-row items-stretch max-w-6xl mx-auto">
                        {/* Phần hình ảnh  https://images.unsplash.com/photo-1501785888041-af3ef285b470   https://static.ecosite.vn/9588/product/2018/11/01/taucaotocmotchieugiuadaophiphiphuket-1541060640.jpg */}
