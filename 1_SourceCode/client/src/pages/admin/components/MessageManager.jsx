...
function MessageManager() {
    ...
    const filteredUsers = users.filter((conv) =>
                                            ...
                                            >
                                                <div className="flex items-start gap-3">
                                                    <div className="relative flex-shrink-0">
                                                        <Avatar
                                                            size={48}
                                                            src={user?.avatar ? `${import.meta.env.VITE_API_URL}/uploads/avatars/${user.avatar}` : null}
                                                        >
                                                            {user?.fullName?.[0]}
                                                        </Avatar>
                                                        <span
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="relative">
                                                    <Avatar
                                                        size={48}
                                                        src={selectedUser.user?.avatar ? `${import.meta.env.VITE_API_URL}/uploads/avatars/${selectedUser.user.avatar}` : null}
                                                    >
